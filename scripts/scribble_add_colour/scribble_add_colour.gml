...
{
    scribble_debug("Scribble: WARNING! Colour name \"" + _name + "\" has already been defined as an event" );
    exit;
}

if ( ds_map_exists(global.__scribble_flags, _name) )
{
    scribble_debug("Scribble: WARNING! Colour name \"" + _name + "\" has already been defined as a flag" );
    exit;
}
...
{
    scribble_debug("Scribble: WARNING! Overwriting colour \"" + _name + "\" (" + string(colour_get_red(_old_colour)) + "," + string(colour_get_green(_old_colour)) + "," + string(colour_get_blue(_old_colour)) + ", u32=" + string(_old_colour) + ")");
}

global.__scribble_colours[? _name ] = _colour;

scribble_debug("Scribble: Added colour \"" + _name + "\" as " + string(colour_get_red(_colour)) + "," + string(colour_get_green(_colour)) + "," + string(colour_get_blue(_colour)) + ", u32=" + string(_colour));